    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.AddPhoneSuccess ? "شماره تلفن همراه شما به ثبت رسید."
                : message == ManageMessageId.RemovePhoneSuccess ? "شماره تلفن همراه شما حذف گردید."
                : "";
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError("", "تلفن همراه شما تائید نشد");
            return View(model);
        }
        ...
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "ورود چند گانه حذف گردید."
                : message == ManageMessageId.Error ? "یک خطا رخ داده است."
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
